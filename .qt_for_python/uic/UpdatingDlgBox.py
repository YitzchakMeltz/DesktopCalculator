...
# Form implementation generated from reading ui file 'c:\Users\hmeltz\Documents\GitHub\DesktopCalculator\ui\UpdatingDlgBox.ui'
#
...
class Ui_UpdatingDlgBox(object):
    def setupUi(self, UpdatingDlgBox):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\hmeltz\\Documents\\GitHub\\DesktopCalculator\\ui\\../Logos/CalculatorLogo(150p)_1.0.0.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
